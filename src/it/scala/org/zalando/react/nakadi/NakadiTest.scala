...
import org.zalando.react.nakadi.client.NakadiClientImpl
import org.zalando.react.nakadi.NakadiMessages.EventTypeMessage
...
trait NakadiTest extends FlatSpec
  ...
  lazy val nakadiClientActor: ActorRef = {
    import org.zalando.react.nakadi.client.Properties
  ...
  def createConsumerProperties: ConsumerProperties = {
    ConsumerProperties(
      ...
      commitHandler = InMemoryCommitCommitManager
  ...
  private def createTopic(): Unit = {
    import org.zalando.react.nakadi.client.models.{EventType, EventTypeCategoryEnum}
